					...
					<td rowspan="3">
						<div class="l" style="margin-left:20px; width:772px;">
							...
							<div
								...
								<form action="/community/freeboard_edit_success.do" onsubmit="return FreeBoard_check()">
									<input type="hidden" name="free_board_no" value="${board.free_board_no}">
									<table class="writeTable">
										<tr>
											<th>제목</th>
											<td><input style="width: 560px;" type="text"
												name="free_board_title" value="${board.free_board_title}"></td>
										</tr>
										<tr>
											<th>내용</th>
											<td><textarea id="freeboard_content" name="free_board_content" style="font-family: Consolas;padding-left:5px;" rows="20"
													cols="70">${board.free_board_content}</textarea></td>
										</tr>
									</table>
									<button type="submit"
